...
TIP: If the selected annotation is not visible enough you can also make it *bold* by selecting  menu:Preferences[Bold selected region].
...
When you first start {lb} it creates a new database in `~/database.labelbuddy`.
